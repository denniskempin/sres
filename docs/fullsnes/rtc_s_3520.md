---
summary: Technical reference for the Seiko/Epson S-3520CF Serial 4-bit Real-Time Clock chip, covering its BCD time/date registers, control/status bits, 120-bit battery-backed SRAM, four register modes, and serial access protocol. Used in the Nintendo Super System (NSS) and Super Famicom Box kiosks.
keywords: S-3520CF, RTC, battery-backed SRAM, Nintendo Super System, Super Famicom Box
importance: 1
---
