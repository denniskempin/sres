...
> **See:** [SNES Add-On Turbo File - TFII Mode Transmission Protocol](add_on_turbo_file_tfii_proto.md)
> **See:** [SNES Add-On Turbo File - TFII Mode Filesystem](add_on_turbo_file_tfii_fs.md)

STF Mode (native SNES mode, 128Kbyte)

> **See:** [SNES Add-On Turbo File - STF Mode Transmission Protocol](add_on_turbo_file_stf_proto.md)
> **See:** [SNES Add-On Turbo File - STF Mode Filesystem](add_on_turbo_file_stf_fs.md)

#### Compatible Games

> **See:** [SNES Add-On Turbo File - Games](add_on_turbo_file_games.md)
