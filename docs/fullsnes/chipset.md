---
summary: Catalog of the original SNES (SNSP-CPU-01) mainboard chipset enumerating each IC (S-CPU, S-PPU1/2, WRAM, VRAM, S-ENC, CIC, S-SMP, S-DSP, etc.) by package, marking, and role, followed by the cost-down chipset that integrates the CPU/PPUs and APU into single chips (S-CPUN, S-APU) and a few common SRAM part numbers.
keywords: SNES chipset, S-CPU, S-PPU, S-SMP, S-DSP
importance: 5
---
# SNES Chipset
