...
pub fn build_opcode_table<BusT: Bus>() -> [Instruction<BusT>; 256] {
    ...
    opcodes[0x8C] = instruction!(sty, AbsoluteData, Read, Y);
    opcodes[0x8D] = instruction!(sta, AbsoluteData, Read, A);
    opcodes[0x8E] = instruction!(stx, AbsoluteData, Read, X);
    ...
    opcodes[0x9C] = instruction!(stz, AbsoluteData, Read, A);
