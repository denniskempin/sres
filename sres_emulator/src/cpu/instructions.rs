...
pub fn build_opcode_table<BusT: Bus>() -> [Instruction<BusT>; 256] {
    ...
    opcodes[0x6D] = instruction!(adc, Absolute, Read, A);
    ...
    opcodes[0x2D] = instruction!(and, Absolute, Read, A);
    ...
    opcodes[0x0E] = instruction!(asl, Absolute, Modify, A);
    ...
    opcodes[0x2C] = instruction!(bit, Absolute, Read, A);
    ...
    opcodes[0xCD] = instruction!(cmp, Absolute, Read, A);
    opcodes[0xCD] = instruction!(cmp, Absolute, Read, A);
    ...
    opcodes[0x4D] = instruction!(eor, Absolute, Read, A);
    ...
    opcodes[0xEE] = instruction!(inc, Absolute, Read, A);
    ...
    opcodes[0x4C] = instruction!(jmp, Absolute, Read);
    opcodes[0x6C] = instruction!(jmp, AbsoluteIndirect, Read);
    opcodes[0x7C] = instruction!(jmp, AbsoluteXIndexedIndirect, Read);
    opcodes[0xDC] = instruction!(jmp, AbsoluteIndirectLong, Read);
    opcodes[0x20] = instruction!(jsr, Absolute, Read);
    opcodes[0xFC] = instruction!(jsr, AbsoluteXIndexedIndirect, Read);
    ...
    opcodes[0xAD] = instruction!(lda, Absolute, Read, A);
    ...
    opcodes[0xAE] = instruction!(ldx, Absolute, Read, X);
    ...
    opcodes[0xAC] = instruction!(ldy, Absolute, Read, Y);
    ...
    opcodes[0x4E] = instruction!(lsr, Absolute, Read, A);
    ...
    opcodes[0x0D] = instruction!(ora, Absolute, Read, A);
    ...
    opcodes[0xF4] = instruction!(pea, Absolute, Read);
    ...
    opcodes[0x2E] = instruction!(rol, Absolute, Modify, A);
    ...
    opcodes[0x66] = instruction!(ror, DirectPage, Read, A);
    opcodes[0x6E] = instruction!(ror, Absolute, Read, A);
    opcodes[0x76] = instruction!(ror, DirectPageXIndexed, Read, A);
    opcodes[0x7E] = instruction!(ror, AbsoluteXIndexed, Read, A);
    ...
    opcodes[0xED] = instruction!(sbc, Absolute, Read, A);
    ...
    opcodes[0x81] = instruction!(sta, DirectPageXIndexedIndirect, Read, A);
    opcodes[0x83] = instruction!(sta, StackRelative, Read, A);
    opcodes[0x85] = instruction!(sta, DirectPage, Read, A);
    opcodes[0x87] = instruction!(sta, DirectPageIndirectLong, Read, A);
    opcodes[0x8D] = instruction!(sta, Absolute, Read, A);
    opcodes[0x8F] = instruction!(sta, AbsoluteLong, Read, A);
    opcodes[0x91] = instruction!(sta, DirectPageIndirectYIndexed, Read, A);
    opcodes[0x92] = instruction!(sta, DirectPageIndirect, Read, A);
    opcodes[0x93] = instruction!(sta, StackRelativeIndirectYIndexed, Read, A);
    opcodes[0x95] = instruction!(sta, DirectPageXIndexed, Read, A);
    opcodes[0x97] = instruction!(sta, DirectPageIndirectYIndexedLong, Read, A);
    opcodes[0x99] = instruction!(sta, AbsoluteYIndexed, Read, A);
    opcodes[0x9D] = instruction!(sta, AbsoluteXIndexed, Read, A);
    opcodes[0x9F] = instruction!(sta, AbsoluteXIndexedLong, Read, A);
    opcodes[0xDB] = instruction!(stp);
    opcodes[0x86] = instruction!(stx, DirectPage, Read, X);
    opcodes[0x8E] = instruction!(stx, Absolute, Read, X);
    opcodes[0x96] = instruction!(stx, DirectPageYIndexed, Read, X);
    opcodes[0x84] = instruction!(sty, DirectPage, Read, Y);
    opcodes[0x8C] = instruction!(sty, Absolute, Read, Y);
    opcodes[0x94] = instruction!(sty, DirectPageXIndexed, Read, Y);
    opcodes[0x64] = instruction!(stz, DirectPage, Read, A);
    opcodes[0x74] = instruction!(stz, DirectPageXIndexed, Read, A);
    opcodes[0x9C] = instruction!(stz, Absolute, Read, A);
    opcodes[0x9E] = instruction!(stz, AbsoluteXIndexed, Read, A);
    ...
    opcodes[0x1C] = instruction!(trb, Absolute, Read, A);
    opcodes[0x04] = instruction!(tsb, DirectPage, Read, A);
    opcodes[0x0C] = instruction!(tsb, Absolute, Read, A);
