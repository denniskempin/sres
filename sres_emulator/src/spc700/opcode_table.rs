...
pub fn build_opcode_table<BusT: Spc700Bus>() -> [InstructionDef<BusT>; 256] {
    ...
    opcodes[0x7A] = instruction!(addw, U16InMemory(Dp));
    ...
    opcodes[0x9A] = instruction!(subw, U16InMemory(Dp));
    ...
    opcodes[0xA3] = instruction!(bbs, Immediate, DpBit(5));
    opcodes[0xA4] = instruction!(sbc, Register(A), U8InMemory(Dp));
    opcodes[0xA5] = instruction!(sbc, Register(A), U8InMemory(Abs));
    opcodes[0xA6] = instruction!(sbc, Register(A), U8InMemory(XIndirect));
    opcodes[0xA7] = instruction!(sbc, Register(A), U8InMemory(DpXIdxIndirect));
    opcodes[0xA8] = instruction!(sbc, Register(A), Immediate);
    opcodes[0xA9] = instruction!(sbc, U8InMemory(Dp), U8InMemory(Dp));
    opcodes[0xAA] = instruction!(mov1, Carry, AbsBit);
    opcodes[0xAB] = instruction!(inc, U8InMemory(Dp));
    opcodes[0xAC] = instruction!(inc, U8InMemory(Abs));
    opcodes[0xAD] = instruction!(cmp, Register(Y), Immediate);
    opcodes[0xAE] = instruction!(pop, Register(A));
    opcodes[0xAF] = instruction!(mov, U8InMemory(XIndirectAutoInc), Register(A));
    opcodes[0xB0] = instruction!(bcs, Immediate);
    opcodes[0xB1] = instruction!(tcall, Const(11));
    opcodes[0xB2] = instruction!(clr1, DpBit(5));
    opcodes[0xB3] = instruction!(bbc, Immediate, DpBit(5));
    opcodes[0xB4] = instruction!(sbc, Register(A), U8InMemory(DpXIdx));
    opcodes[0xB5] = instruction!(sbc, Register(A), U8InMemory(AbsXIdx));
    opcodes[0xB6] = instruction!(sbc, Register(A), U8InMemory(AbsYIdx));
    opcodes[0xB7] = instruction!(sbc, Register(A), U8InMemory(DpIndirectYIdx));
    opcodes[0xB8] = instruction!(sbc, U8InMemory(Dp), Immediate);
    opcodes[0xB9] = instruction!(sbc, U8InMemory(XIndirect), U8InMemory(YIndirect));
    opcodes[0xBA] = instruction!(movw, RegisterYA, U16InMemory(Dp));
    opcodes[0xBB] = instruction!(inc, U8InMemory(DpXIdx));
    opcodes[0xBC] = instruction!(inc, Register(A));
    opcodes[0xBD] = instruction!(mov, Register(Sp), Register(X));
    opcodes[0xBE] = instruction!(das);
    opcodes[0xBF] = instruction!(mov, Register(A), U8InMemory(XIndirectAutoInc));
    opcodes[0xC0] = instruction!(di);
    opcodes[0xC1] = instruction!(tcall, Const(12));
    opcodes[0xC2] = instruction!(set1, DpBit(6));
    opcodes[0xC3] = instruction!(bbs, Immediate, DpBit(6));
    opcodes[0xC4] = instruction!(mov, U8InMemory(Dp), Register(A));
    opcodes[0xC5] = instruction!(mov, U8InMemory(Abs), Register(A));
    opcodes[0xC6] = instruction!(mov, U8InMemory(XIndirect), Register(A));
    opcodes[0xC7] = instruction!(mov, U8InMemory(DpXIdxIndirect), Register(A));
    opcodes[0xC8] = instruction!(cmp, Register(X), Immediate);
    opcodes[0xC9] = instruction!(mov, U8InMemory(Abs), Register(X));
    opcodes[0xCA] = instruction!(mov1, AbsBit, Carry);
    opcodes[0xCB] = instruction!(mov, U8InMemory(Dp), Register(Y));
    opcodes[0xCC] = instruction!(mov, U8InMemory(Abs), Register(Y));
    opcodes[0xCD] = instruction!(mov, Register(X), Immediate);
    opcodes[0xCE] = instruction!(pop, Register(X));
    opcodes[0xCF] = instruction!(mul);
    opcodes[0xD0] = instruction!(bne, Immediate);
    opcodes[0xD1] = instruction!(tcall, Const(13));
    opcodes[0xD2] = instruction!(clr1, DpBit(6));
    opcodes[0xD3] = instruction!(bbc, Immediate, DpBit(6));
    opcodes[0xD4] = instruction!(mov, U8InMemory(DpXIdx), Register(A));
    opcodes[0xD5] = instruction!(mov, U8InMemory(AbsXIdx), Register(A));
    opcodes[0xD6] = instruction!(mov, U8InMemory(AbsYIdx), Register(A));
    opcodes[0xD7] = instruction!(mov, U8InMemory(DpIndirectYIdx), Register(A));
    opcodes[0xD8] = instruction!(mov, U8InMemory(Dp), Register(X));
    opcodes[0xD9] = instruction!(mov, U8InMemory(DpYIdx), Register(X));
    opcodes[0xDA] = instruction!(movw, U16InMemory(Dp), RegisterYA);
    opcodes[0xDB] = instruction!(mov, U8InMemory(DpXIdx), Register(Y));
    opcodes[0xDC] = instruction!(dec, Register(Y));
    opcodes[0xDD] = instruction!(mov, Register(A), Register(Y));
    opcodes[0xDE] = instruction!(cbne, Immediate, U8InMemory(DpXIdx));
    ...
    opcodes[0xE3] = instruction!(bbs, Immediate, DpBit(7));
    opcodes[0xE4] = instruction!(mov, Register(A), U8InMemory(Dp));
    opcodes[0xE5] = instruction!(mov, Register(A), U8InMemory(Abs));
    opcodes[0xE6] = instruction!(mov, Register(A), U8InMemory(XIndirect));
    opcodes[0xE7] = instruction!(mov, Register(A), U8InMemory(DpXIdxIndirect));
    opcodes[0xE8] = instruction!(mov, Register(A), Immediate);
    opcodes[0xE9] = instruction!(mov, Register(X), U8InMemory(Abs));
    opcodes[0xEA] = instruction!(not1, AbsBit);
    opcodes[0xEB] = instruction!(mov, Register(Y), U8InMemory(Dp));
    opcodes[0xEC] = instruction!(mov, Register(Y), U8InMemory(Abs));
    opcodes[0xED] = instruction!(not1, Carry);
    opcodes[0xEE] = instruction!(pop, Register(Y));
    opcodes[0xEF] = instruction!(sleep);
    opcodes[0xF0] = instruction!(beq, Immediate);
    opcodes[0xF1] = instruction!(tcall, Const(15));
    opcodes[0xF2] = instruction!(clr1, DpBit(7));
    opcodes[0xF3] = instruction!(bbc, Immediate, DpBit(7));
    opcodes[0xF4] = instruction!(mov, Register(A), U8InMemory(DpXIdx));
    opcodes[0xF5] = instruction!(mov, Register(A), U8InMemory(AbsXIdx));
    opcodes[0xF6] = instruction!(mov, Register(A), U8InMemory(AbsYIdx));
    opcodes[0xF7] = instruction!(mov, Register(A), U8InMemory(DpIndirectYIdx));
    opcodes[0xF8] = instruction!(mov, Register(X), U8InMemory(Dp));
    opcodes[0xF9] = instruction!(mov, Register(X), U8InMemory(DpYIdx));
    opcodes[0xFA] = instruction!(mov, U8InMemory(Dp), U8InMemory(Dp));
    opcodes[0xFB] = instruction!(mov, Register(Y), U8InMemory(DpXIdx));
    opcodes[0xFC] = instruction!(inc, Register(Y));
    opcodes[0xFD] = instruction!(mov, Register(Y), Register(A));
    opcodes[0xFE] = instruction!(dbnz, Register(Y), Immediate);
